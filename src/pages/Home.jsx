...
const Home = () => {
    ...
    () => {
      ...
      mm.add(
        ...
        (ctx) => {
          ...
          gsap.set(".hero-content > *", { opacity: 0, y: reduced ? 0 : 40 });
  ...
  return (
    <main
      ref={container}
      className="relative min-h-screen w-full bg-black overflow-hidden flex items-center justify-center flex-col gap-4"
    >
